...
Additionally, after opening a doc, you can click on the "Expand sidebar" in the top right corner, where you will find the chat entry for AFFiNE AI in the sidebar.`
  ...
  },
  {
    ...
    answer: `AFFiNE only sends related content information to third-party AI vendors when you use AFFiNE AI. If you have any questions, you can refer to our <a href="/terms#ai" target="_blank">AI terms</a> for policy usage and limits.`
  },
  {
...
.ai-question-and-answers
  .ai-qna-collapse
    ...
    .el-collapse-item
      ...
      &__header
        padding: 16px 34px 14px 24px
        font-weight: 500;
        font-size: 18px;
        line-height: 24px;
        letter-spacing: -0.02em;
        color: #424149 !important
