export default {
  ...
  overviewPage: {
    ...
    privacyFirstItemC:
      "AFFiNE is built upon fully extensible and customisable foundation open-source frameworks.",
    privacyFirstItemD:
      "We ensure real-time syncing with decentralised storage.<br/>WITHOUT VENDOR lock-in and CRYPTO.",
    buildInPublicTitle: "AFFiNE builds\neverything in public",
    buildInPublicOpenSource: "Open-Source Code for Trust and Collaboration",
    buildInPublicIssueDesc:
    ...
    snsDesc:
      'AFFiNE is an <span class="hashtag">#OpenSource</span> software, built with ',
  ...
  downloadPage: {
    ...
    headlineLinkYouCanTry:
      "Download the AFFiNE Client for a feature-rich experience, without compromise.\nA limited version is also available to ",
    ...
    stable: "Stable",
    stableDesc:
      "Download the AFFiNE Client for offline-enabled work and enhanced device-stored privacy.",
  ...
  whatIsNewPage: {
    title: `What’s new`,
    desc: "New updates and improvements to AFFiNE.",
